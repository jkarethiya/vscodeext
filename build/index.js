...
server.tool("read-file", "Read the contents of a file", {
...
server.tool("write-file", "Write content to a file", {
...
server.tool("list-directory", "List contents of a directory", {
...
server.tool("execute-command", "Execute a shell command", {
...
server.tool("search-files", "Search for files by name pattern", {
...
// Tool: Get file info
server.tool("get-file-info", "Get detailed information about a file or directory", {
...
server.tool("get-weather-alerts", "Get weather alerts for a US state (demo tool)", {
